...
const Terms = (): ReactElement => {
  return (
    <div>
      ...
      <p>Last updated: March 21, 2021</p>
      ...
      <ul>
      <li>
      <p><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named Hypercart</p>
      </li>
      <li>
      ...
      <li>
      <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Hypercart LLC, 1200 Grand Oaks Cove, Hoover, AL 35022.</p>
      </li>
      <li>
      ...
      <p>If You are a copyright owner, or authorized on behalf of one, and You believe that the copyrighted work has been copied in a way that constitutes copyright infringement that is taking place through the Service, You must submit Your notice in writing to the attention of our copyright agent via email at support@hypercart.io and include in Your notice a detailed description of the alleged infringement.</p>
      ...
      <p>You can contact our copyright agent via email at support@hypercart.io.
      ...
      <p>We do not hold liability for any item(s) purchased through Our Service. You are fully responsible to use Our Service appropriately, and You will not be granted any type of return or refund for item(s) purchased through Our Service.</p>
      <p>We do not guarantee that any item(s) that You select to purchase through Our Service can be purchased by Our Service. You will not receive any return or refund for Your Subscription in the event that Our Service fails to purchase the selected item(s).</p>
      <p>We do not guarantee any specific rate of success of Our Service for item(s) that You select to purchase.</p>
      ...
      <ul>
      <li>By email: support@hypercart.io</li>
      </ul>
    </div>
  );
};
