...
import { merchantStyles } from './MerchantAddForm.styles';
...
const initialValues: IMerchantModel = {
  id: '',
  domain: '',
  name: '',
  imagePath: '/assets/walmart.svg',
  isFlagged: false,
  isSupported: false,
  supportLevel: 0,
...
const MerchantAddForm = (): ReactElement => {
  ...
  const {
    dataStore: {
      merchantStore: { addMerchantAsync, loading },
    },
  } = useStore();
  ...
  const formik = useFormik<IMerchantModel>({
    initialValues,
    validationSchema,
    onSubmit: (values) => addMerchantAsync(values, () => history.push('/dashboard/merchants')),
  });
        ...
        <Grid container direction="row" justify="center" alignItems="center" spacing={4}>
          <Grid item>
            <Badge
              ...
              <Avatar alt="image" src={initialValues.imagePath} className={classes.avatar} />
            </Badge>
          </Grid>
