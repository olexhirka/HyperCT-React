...
const PrivacyPolicy = (): ReactElement => {
  return (
    <div>
      ...
      <li>
      <p><strong>Website</strong> refers to Hypercart, accessible from <a href="https://www.hypercart.io" rel="external nofollow noopener" target="_blank">https://www.hypercart.io</a></p>
      </li>
      <li>
